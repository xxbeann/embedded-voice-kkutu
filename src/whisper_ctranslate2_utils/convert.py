...
def main():
    parser = argparse.ArgumentParser(description="Convert OpenAI's Whisper models to CTranslate2 format")
    parser.add_argument("--model-size", default="base", choices=MODEL_NAMES, help="Model size to convert")
