...
def app():
    ...
    parser.add_argument("--disable-voice", action="store_true", help="Disable voice recognition")
    parser.add_argument("--disable-stdin", action="store_true", help="Disable stdin input")
